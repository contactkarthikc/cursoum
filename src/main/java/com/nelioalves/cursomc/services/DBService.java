...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p9 = new Produto(null, "Abajour", 1080.00);
		...
		cat4.getProdutos().addAll(Arrays.asList(p9, p10));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "paulo.fernandes@serpro.gov.br", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Clara", "paulo.fernandes@yahoo.com.br", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("29993323", "22228393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida 123", "5", "lj4", "Centro", "20888562", cli2, c2);
